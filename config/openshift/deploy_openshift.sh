...
oc apply -k "$SCRIPT_BASE_DIR/manifests/service-mesh/operator/base"
...
oc apply -k "$SCRIPT_BASE_DIR/manifests/service-mesh/instance/base"

# Install Connectivity Link Operator
echo "Installing Connectivity Link Operator..."
oc apply -k "$SCRIPT_BASE_DIR/manifests/connectivity-link/operator/base"
...
oc apply -k "$SCRIPT_BASE_DIR/manifests/connectivity-link/instance/base"
